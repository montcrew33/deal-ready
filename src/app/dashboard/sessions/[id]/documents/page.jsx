      ...
      <main className="max-w-4xl mx-auto px-6 py-10 space-y-6 animate-fade-in">
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            {/* Badge 1 — Encryption */}
            <div className="flex flex-col gap-3 px-4 py-4 rounded-xl border border-indigo-200/60 bg-indigo-50">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 bg-indigo-100 border border-indigo-200">
                  <svg className="w-3.5 h-3.5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                      d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                </div>
                <span className="text-[11px] font-semibold tracking-wide text-indigo-700">
                  AES-256 Encrypted
                </span>
              </div>
